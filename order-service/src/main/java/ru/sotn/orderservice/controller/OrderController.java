...
//    private final WebClient webClient;
    ...
    public CompletableFuture<OrderDto> placeOrder(@RequestBody OrderDto orderRequest) {

        return CompletableFuture.supplyAsync(() -> mapToDto.orderToDto(orderService.placeOrder(orderRequest)));
    }
    ...
    @ResponseStatus(HttpStatus.OK)
    public Mono<List<OrderDto>> getAllOrder(){
